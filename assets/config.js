...
export const INTRO = "Pick your name, then put every tutorial you can attend in order of preference — best first. You will be placed in a group of about five and given one of the slots you listed.";
